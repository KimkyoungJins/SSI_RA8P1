...
{ .channel = 1, .rate = I2C_MASTER_RATE_STANDARD, .slave = 0x1A, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
...
/* Actual period: 7.08e-7 seconds. Actual duty: 49.717514124293785%. */.period_counts = (uint32_t) 0xb1,
  .duty_cycle_counts = 0x58, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
...
{ .audio_clock = (ssi_audio_clock_t) SSI_AUDIO_CLOCK_INTERNAL, .bit_clock_div = SSI_CLOCK_DIV_2, };
...
{ .channel = 0, .pcm_width = I2S_PCM_WIDTH_16_BITS, .operating_mode = I2S_MODE_MASTER, .word_length =
  ...
  .ws_continue = I2S_WS_CONTINUE_OFF, .p_callback = i2s_callback, .p_context = NULL, .p_extend = &g_i2s_cfg_extend,
